...
export const maxDuration = 300; // 5 minutes max (FLUX can take ~90s, leave headroom)
...
export async function POST(request: NextRequest) {
  ...
  const { prompt, negative_prompt, width, height, seed, guidance_scale, num_inference_steps, model_mode } = body;
